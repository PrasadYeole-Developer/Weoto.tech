...
const CalendlySection = () => {
  return (
    <section className="w-full min-h-[70vh] flex items-center justify-center py-16 px-4">
      <div className="w-full max-w-5xl bg-white/90 rounded-lg shadow-xl p-8 md:p-12 flex flex-col items-center gap-2">
        ...
        <div className="w-full flex justify-center">
          <div className="w-full max-w-xl min-h-[600px] rounded shadow-lg bg-white">
