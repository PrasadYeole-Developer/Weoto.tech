      ...
      <section className="w-full min-h-screen bg-[#DBEAFE] text-[#020023] flex flex-col items-center justify-center py-8 pt-16 gap-2 select-none">
        ...
        >
          ...
          <div className="flex w-full mt-2">
            <button
              type="submit"
              className="border rounded-xs border-[#020023] font-sans font-bold flex gap-2 items-center justify-center py-2.5 px-5 cursor-pointer bg-[#020023] text-white active:scale-[0.98] hover:bg-white hover:text-[#020023] transition-all duration-300 uppercase disabled:opacity-50 disabled:cursor-not-allowed"
