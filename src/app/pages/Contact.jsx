...
const Contact = () => {
  return (
    <div className="w-full min-h-screen bg-[#DBEAFE] text-black flex items-center justify-center py-16">
      <div className="max-w-5xl w-full mx-auto px-4 md:px-8 flex flex-col md:flex-row items-center gap-12">
        <div className="flex-1 flex flex-col items-center md:items-start">
          ...
          <p className="text-gray-600 text-base md:text-lg mt-2 text-center md:text-left">
            ...
            you are interested in working with us, please send us an email.
          </p>
        </div>
