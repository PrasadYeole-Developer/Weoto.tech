        ...
        <div className="max-w-5xl w-full mx-auto px-4 md:px-8 flex flex-col gap-10">
          <div className="flex flex-col items-center text-center gap-4">
            ...
            <p className="text-gray-700 text-base md:text-lg max-w-2xl">
              Weoto empowers businesses across diverse industries with tailored
              software solutions, helping them gain competitiveness and agility
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-8">
            <div className="bg-white rounded-xl shadow-lg p-6 flex flex-col items-center hover:shadow-2xl transition-shadow duration-200">
              <div className="w-16 h-16 mb-4 flex items-center justify-center bg-[#E0E7FF] rounded-full">
                <span role="img" aria-label="Retail" className="text-3xl">
                  🛒
                </span>
              </div>
              ...
              <p className="text-gray-600 text-sm text-center">
                Scalable ecommerce platforms, inventory management, and seamless
                customer experiences for B2B and B2C.
              </p>
            </div>
            <div className="bg-white rounded-xl shadow-lg p-6 flex flex-col items-center hover:shadow-2xl transition-shadow duration-200">
              <div className="w-16 h-16 mb-4 flex items-center justify-center bg-[#E0E7FF] rounded-full">
              ...
              <p className="text-gray-600 text-sm text-center">
                Custom ERP, supply chain optimization, and automation to
                streamline operations and boost productivity.
              </p>
            </div>
            <div className="bg-white rounded-xl shadow-lg p-6 flex flex-col items-center hover:shadow-2xl transition-shadow duration-200">
              <div className="w-16 h-16 mb-4 flex items-center justify-center bg-[#E0E7FF] rounded-full">
                <span role="img" aria-label="Healthcare" className="text-3xl">
                  💊
                </span>
              </div>
              <h3 className="text-xl font-semibold mb-2 text-[#004AAD]">
              ...
              <p className="text-gray-600 text-sm text-center">
                Secure, compliant solutions for patient management,
